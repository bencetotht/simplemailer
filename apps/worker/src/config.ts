...
export function resolveConfig(): WorkerConfig {
  ...
  return {
    ...
    s3ForcePathStyle: parseBoolean('S3_FORCE_PATH_STYLE', false),
    ...
    webhookDispatchIntervalMs: parseNumber('WEBHOOK_DISPATCH_INTERVAL_MS', 1_000),
    webhookRequestTimeoutMs: parseNumber('WEBHOOK_REQUEST_TIMEOUT_MS', 10_000),
    webhookLeaseMs: parseNumber('WEBHOOK_LEASE_MS', 30_000),
    webhookMaxAttempts: parseNumber('WEBHOOK_MAX_ATTEMPTS', 8),
